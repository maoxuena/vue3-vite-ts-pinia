    ...
    var t = {
        686: function (t, e, n) {
          ...
          var y = function () {
            ...
            return i ? d(i, { container: o }) : r ? ('cut' === n ? l(r) : d(r, { container: o })) : void 0
          }
          function v(t) {
            return (v =
              'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      var e = t.delegateTarget || t.currentTarget,
                        ...
                        o = y({ action: n, container: this.container, target: this.target(e), text: this.text(e) })
...
var E = e((x.exports = w()))
const S = async (t) => {
  const { toClipboard: e } = ((t) => {
    const e = void 0 === (null == t ? void 0 : t.appendToBody) || t.appendToBody
    return {
      toClipboard: (t, n) =>
        new Promise((o, r) => {
          const i = document.createElement('button'),
            c = new E(i, { text: () => t, action: () => 'copy', container: void 0 !== n ? n : document.body })
          c.on('success', (t) => {
            c.destroy(), o(t)
          }),
            c.on('error', (t) => {
  ...
  try {
    await e(t),
      ((t) => {
        window.$message.success(`${t} 复制成功`, { duration: 1500 })
      })(t)
  } catch (n) {
    ;((t) => {
      window.$message.success(`${t} 复制失败`, { duration: 1500 })
    })(t)
  }
}
const T = { class: 'icon-wrap' },
  k = ['onClick']
var A = n(
  o({
    props: { title: { default: '' }, icons: { default: () => [] } },
    setup: (t) => (e, n) => {
      const o = r('n-divider'),
        v = r('svg-icon'),
        m = r('n-empty'),
      ...
      return (
        ...
        c(
          ...
          null,
          [
            u(o, { 'title-placement': 'left' }, { default: a(() => [s(l(t.title), 1)]), _: 1 }),
            0 === t.icons.length
              ? (i(), f(m, { key: 0, description: '暂无图标' }, { icon: a(() => [u(v, { name: 'no-data-file' })]), _: 1 }))
              : (i(),
                f(
                  g,
                  { key: 1, 'x-gap': 10, 'y-gap': 10, cols: '2 450:3 600:4 750:5 900:6 1050:7 1200:8 1350:9 1500:10 1650:11 1800:12' },
                  {
                    default: a(() => [
                      (i(!0),
                      c(
  ...
  [['__scopeId', 'data-v-cb6664aa']]
)
const C = o({
  setup(t) {
    var e, n
    const o = { '../../../assets/svg/icons/logistics-track.svg': m },
      r = v([])
    for (const i in o) {
      const t = i.split('/').pop(),
        n = null == (e = null == t ? void 0 : t.split('.')) ? void 0 : e.shift()
      r.value.push(n)
    }
    const a = {
        '../../../assets/svg/icons/fileType/excel.svg': h,
        '../../../assets/svg/icons/fileType/ppt.svg': g,
        '../../../assets/svg/icons/fileType/word.svg': b,
      },
      s = v([])
    for (const i in a) {
      const t = i.split('/').pop(),
        e = null == (n = null == t ? void 0 : t.split('.')) ? void 0 : n.shift()
      s.value.push(e)
    }
    return (t, e) => (
      i(),
      c(
        ...
        null,
        [
          u(A, { title: '网站通用图标', icons: r.value }, null, 8, ['icons']),
          u(A, { title: '文件类型图标（fileType）', icons: s.value }, null, 8, ['icons']),
          u(A, { title: '表单类图标' }),
          u(A, { title: '方向性图标' }),
          u(A, { title: '提示建议性图标' }),
          u(A, { title: '编辑类图标' }),
